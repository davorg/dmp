...
languages are also available. A tab character is matched by \\t, a newline
...
will look something like this:
	 ...
	 12:   my \$word = shift;
	 13:
	 14:   \$trans{lc \$word} ||= get\_trans(lc \$word);
	 15: }
	 16:
	 17: sub get\_trans {
	 18:   my \$word = shift;
...
%trans hash, it
calls get\_trans to get a translation of the word. Notice that we
...
from the CPAN at http://search.cpan.org/search?dist=Text-Bastardize.
