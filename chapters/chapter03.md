...
![The unsorted array of CD hashes](images/3-1-the-unsorted-array-of-cd-hashes.svg)
...
![`@CD_and_year` contains references to a two-element array](images/3-2-cd_and_year-contains-references-to-a-two-element-array.svg)
...
![`@sorted_CD_and_year` is `@CD_and_year` sorted by the first element of the array](images/3-3-sorted-by-first-element-of-array.svg)
...
![`@CDs_sorted_by_year` contains just the hash references from `@sorted_CD_and_year`](images/3-4-just-the-hash-references.svg)
